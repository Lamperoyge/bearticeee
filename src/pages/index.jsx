...
import avatar from '../images/betty.jpg';
  ...
  <React.Fragment>
    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          <BigTitle>
            Hello, <br /> call me Betty.
          </BigTitle>
          <Subtitle>I'm creating Art and more :)</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            <ProjectCard
              title="| concept | Neamul Movilestilor Wine |"
              link="https://www.behance.net/gallery/61999551/-concept-Neamul-Movilestilor-Wine-BONSANCO"
              bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
            >
              Project description care daca vrei mi-l trimiti dupa :D
              Design | Concept development - Beatrice Moraru.
            </ProjectCard>
            <ProjectCard
              title="Transfagrasan - Romania"
              link="https://www.behance.net/gallery/69623215/Transfagarasan-Romania"
              bg="linear-gradient(to right, #662D8C 0%, #ED1E79 100%)"
            >
              Photo project description inc una insert aici plsss
            </ProjectCard>
            <ProjectCard
              title="rose | F'autor Winery "
              link="https://www.behance.net/gallery/63812887/ros-Fautor-Winery-BONSANCO"
              bg="linear-gradient(to right, #009245 0%, #FCEE21 100%)"
            >
              This project was made to stand out on the shelf, to attract the costumer with its vibrant color and contrast and additionally to reveal the product’s quality.
            </ProjectCard>
            <ProjectCard
              title="Sol Eos /concept/"
              link="https://www.behance.net/gallery/63403875/Sol-Eos-concept-BONSANCO"
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            Say <a href="mailto:beatrice1moraru@gmail.com">Hi</a> or find me on other platforms:{' '}
            <a href="https://www.behance.net/beARTice">Behance</a> , {' '}
            <a href="https://www.instagram.com/bettycutza/">Instagram</a> & {' '}
            <a href="https://www.facebook.com/bearticephotos/">Facebook</a>
